...
for side in left right; do
    ...
    ip netns exec "$ns" sysctl -w net.ipv6.conf.default.disable_ipv6=0
...
# Allow neighbour discovery to complete before asserting forwarding readiness.
ip netns exec "$task_ns_left" ping -6 -c 3 -W 2 2001:db8:10::1
ip netns exec "$task_ns_right" ping -6 -c 3 -W 2 2001:db8:20::1
ip netns exec "$task_ns_left" ping -6 -c 3 -W 2 2001:db8:20::2
